defmodule ChatElixirWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 z-50 rounded-lg p-3 ring-1",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatElixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatElixirWeb.Gettext, "errors", msg, opts)
    end
  end
